...
{
    public class TaskInfoViewBehaviors
    {
        ...
        public static readonly DependencyProperty ViewLoadMethodNameProperty =
            DependencyProperty.RegisterAttached("ViewLoadMethodName", typeof(string), typeof(TaskInfoViewBehaviors), new PropertyMetadata(null, MvvmBehaviors.OnLoadMethodNameChanged));
