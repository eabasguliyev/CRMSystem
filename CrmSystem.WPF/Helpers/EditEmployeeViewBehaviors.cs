...
namespace CrmSystem.WPF.Helpers
{
    public class EditEmployeeViewBehaviors
    {
        ...
        public static readonly DependencyProperty LoadRolesMethodNameProperty =
            DependencyProperty.RegisterAttached("LoadRolesMethodName", typeof(string), typeof(EditEmployeeViewBehaviors), new PropertyMetadata(null, MvvmBehaviors.OnLoadMethodNameChanged));
        ...
        public static readonly DependencyProperty LoadProfilesMethodNameProperty =
            DependencyProperty.RegisterAttached("LoadProfilesMethodName", typeof(string), typeof(EditEmployeeViewBehaviors), new PropertyMetadata(null, MvvmBehaviors.OnLoadMethodNameChanged));
